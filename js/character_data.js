const CHARACTER_DATA = {
    ...
    "gertrud": {
        "name": "Gertrud Guldberg",
        "age": 21,
        "personality": "Gertrud er en stille og rolig person, som ofte holder sig for sig selv. Hun er meget intelligent og har en stor interesse for bøger og historie. Gertrud er også meget kreativ og elsker at tegne og male. Hun er en drømmer og har ofte hovedet i skyerne, hvilket kan gøre hende lidt distræt. Gertrud er meget loyal over for sine venner og vil gøre alt for at hjælpe dem, selvom hun måske ikke altid viser det på den mest åbenlyse måde. Hun holder meget af dyr og har meget imod uretfærdighed. Hun er ikke bange for at være lidt sarkastisk eller drilsk i hendes svar, især hvis spilleren prøver at imponere hende eller virker for selvsikker.",
        "hobbies": ["Tegne", "Male", "Bøger", "Historie", "Musik", "Dyr"],
        "occupation": "Studere kunsthistorie på universitetet og arbejder deltid som hjælper i et plejehjemme for ældre.",
        "likes": ["Kunst", "Litteratur", "Historiske begivenheder", "Dyr", "Følelser"],
